...
///
abstract contract Vault is TwabERC20, IERC4626, ILiquidationSource, Ownable {
    ...
    /// @param twabController_ Address of the TwabController to store balances
    ...
    constructor(
        ...
        address owner_
    ) TwabERC20(name_, symbol_, twabController_) Ownable(owner_) {
    ...
    function transferTokensOut(
        ...
        return _transferYieldOut(_sender, _receiver, _tokenOut, _amountOut);
    }
    ...
    /// @inheritdoc ILiquidationSource
    function targetOf(address /* tokenIn */) external virtual returns (address);
